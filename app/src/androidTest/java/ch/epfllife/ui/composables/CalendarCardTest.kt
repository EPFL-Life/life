...
class CalendarCardTest {
  ...
  fun calendarCard_displaysContentCorrectly() {
    composeTestRule.setContent { Theme { CalendarCard(event = event, onClick = {}) } }
    ...
    composeTestRule.assertTagTextEquals(CalendarTestTags.EVENT_ASSOCIATION, event.association.name)
