...
class EventDetailsTest {
    ...
    fun viewModel_EnrollInEventUpdatesState() = runTest {
        ...
        if (initialState is EventDetailsUIState.Success) {
            ...
            assertTrue(
                ...
                enrolledState is EventDetailsUIState.Success
            )
    ...
    fun content_ViewLocationButtonIsClickable() {
        ...
        composeTestRule.onNodeWithTag(EventDetailsTestTags.VIEW_LOCATION_BUTTON)
    ...
    fun content_HandlesEventWithMultipleTags() {
        val eventWithTags =
            sampleEvent.copy(tags = setOf("workshop", "tech", "drone", "engineering"))
        composeTestRule.setContent {
