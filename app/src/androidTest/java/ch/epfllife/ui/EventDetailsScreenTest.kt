...
/**
 * UI tests for the EventDetailsScreen composable.
 * These tests verify that the event details, image, and buttons are correctly displayed
 * and that interactions such as navigation and enrollment work as expected.
 */
class EventDetailsScreenTest {
    ...
    /**
     * Ensures that the date and time information are shown.
     * Option 2 fix: avoids failure when multiple identical nodes are found.
     */
    @Test
