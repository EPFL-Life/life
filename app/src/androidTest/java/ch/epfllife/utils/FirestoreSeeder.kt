 ...
 *
 * !!! THIS EDITS THE ACTUAL PROD DATABASE AND IS TO BE EXECUTED ONLY AND ONLY MANUALLY IN DEVELOPMENT
 * !!! DON'T EXECUTE UNLESS YOU KNOW WHAT YOU'RE DOING
 * (ask daniel if not sure)
 *
 * HOW TO USE:
